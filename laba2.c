...
/* 2. Ввести с консоли его значения, вывести на консоль сумму его элементов, расположенных на главной диаонаи  сумму лементов
/*3. расположенных на  побочной диагонали. */
/* 1.	Объявить массив данных типа int размером  на 2. */
